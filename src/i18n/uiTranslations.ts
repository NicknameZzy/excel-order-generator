...
const uiTranslations: Record<UiLanguage, UiLabels> = {
  zh: {
    ...
    tabHistory: '历史',
    rowLabel: '第 {n} 行',
    localNote: '历史仅保存在本机当前浏览器，不会上传，也不会与其他电脑同步。',
    footer: 'Excel 订单表格生成器 · 本地保存 · 支持公式导出',
    copySuffix: '（副本）',
    modelSuggestions: '常用型号建议',
    modelHistory: '产品型号历史',
    modelHistoryHint: '保存或导出订单后自动记录，仅保存在当前浏览器。',
  ...
  en: {
    ...
    tabHistory: 'History',
    rowLabel: 'Row {n}',
    localNote: 'History stays in this browser only. It is never uploaded or shared across devices.',
    ...
    modelHistoryHint: 'Learned when an order is saved or exported. Stored only in this browser.',
  ...
  pt: {
    ...
    rowLabel: 'Linha {n}',
    localNote: 'O histórico fica só neste navegador. Não é enviado nem sincronizado entre computadores.',
    ...
    modelHistoryHint: 'Registrado ao salvar ou exportar. Armazenado somente neste navegador.',
